# 使用docsify搭建一个贼简单的所见即所得博客！ 🔥

> 111

## 博客搭建

有很多小伙伴，想长期拥有一个漂亮的博客，不过苦于没有自己的域名，也没有一些云服务器，还不太会前端的玩意。之后搞的太复杂又没有时间维护，那有没有简单点的方式，就能搞一个这样博客呢？

比如我这样的：[https://blog.caijy.top](https://blog.caijy.top)

那当然有哇，我强烈推荐 docsify 这货简直是傻白甜都能使用，直接在 GitHub/Gitee 维护一个文档仓库，就可以拥有一个漂亮、简单、好用，易于维护和所见即所得的博客。
...
接下来就教你构建这样一个博客，因为我已经帮你准备好了博客模板，所以在这个过程中，你只要跟着步骤，点点点，就部署完事了。**那整吧**，`咱们走起`！
